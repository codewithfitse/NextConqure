// Client mirror of server types (JSDoc only)
...
/** @typedef {{ roomId: string, status: 'lobby'|'active'|'finished', players: PlayerState[], currentPlayerId: string|null, winnerId: string|null, deck: Card[], discardPile: Card[], melds: Meld[], lastAction?: string }} GameState */
